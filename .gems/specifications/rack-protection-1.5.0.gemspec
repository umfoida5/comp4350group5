...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase", "Alex Rodionov", "Chris Heald", "Chris Mytton", "Corey Ward", "David Kellum", "Egor Homakov", "Florian Gilcher", "Fojas", "Mael Clerambault", "Martin Mauch", "SAKAI, Kazuaki", "Stanislav Savulchik", "Steve Agalloco", "Akzhan Abdulin", "TOBY", "Bj\303\270rge N\303\246ss"]
  s.date = %q{2013-03-13}
