...
- (void)viewDidLoad
{
	...
	calendarView.currentMonthField = [[UILabel alloc] init];
	...
	//  Draw Day Titles
	calendarView.sundayField = [[UILabel alloc] init];
	calendarView.mondayField = [[UILabel alloc] init];
	calendarView.tuesdayField = [[UILabel alloc] init];
	calendarView.wednesdayField = [[UILabel alloc] init];
	calendarView.thursdayField = [[UILabel alloc] init];
	calendarView.fridayField = [[UILabel alloc] init];
	calendarView.saturdayField = [[UILabel alloc] init];
